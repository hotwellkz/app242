          ...
          <div className="border-t border-gray-100 p-4 bg-gray-50 bg-opacity-50 backdrop-blur-sm">
            <div className="flex flex-col space-y-3">
              <button
                ...
                className="flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 px-4 py-2 hover:bg-white rounded-lg transition-all duration-200 group"
              >
                <User className="w-4 h-4 transition-transform duration-200 group-hover:scale-110" />
                <span className="truncate">{auth.currentUser?.displayName}</span>
              </button>
              {isAdmin && (
                <button
